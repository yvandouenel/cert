    ...
    <div class="<?php print $container_class; ?>">
      <div class="col-md-3 col-sm-9 col-xs-9">
        ...
        <?php if (!empty($site_slogan)): ?>
          <h1 class="lead"><?php print $site_slogan; ?></h1>
        <?php endif; ?>
      </div>
...
<div class="main-container <?php print $container_class; ?>">
  ...
  <div class="row">
    ...
    <section<?php print $content_column_class; ?>>
      ...
      <?php if (!empty($page['content-col-1'])): ?>
          <div class="col-md-4">
        <?php print render($page['content-col-1']); ?>
          </div>
      <?php endif; ?>
      <?php if (!empty($page['content-col-2'])): ?>
        <div class="col-md-4">
        <?php print render($page['content-col-2']); ?>
        </div>
      <?php endif; ?>
      <?php if (!empty($page['content-col-3'])): ?>
        <div class="col-md-4">
        <?php print render($page['content-col-3']); ?>
        </div>
      <?php endif; ?>
    </section>
